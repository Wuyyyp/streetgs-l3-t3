    ...
    if 'image' in process_list:
        ...
        for frame_id, frame in tqdm(enumerate(datafile)):
            for camera_name, camera_name_str in camera_names_dict.items():                    
                ...
                cv2.imwrite(img_path, cv2.cvtColfor(img, cv2.COLOR_RGB2BGR))
...
def main():
    ...
    parser.add_argument('--root_dir', type=str, default='/home/yusen/Downloads/waymo_data_141/training')
    parser.add_argument('--save_dir', type=str, default='/home/yusen/Downloads/waymo_data_141/training/surrounding')
    parser.add_argument('--track_file', type=str, default='/home/yusen/Downloads/waymo_data_141/result.json')
