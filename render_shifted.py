#!/usr/bin/env python3
"""
Shift ego poses and render novel trajectory images.

Combines the functionality of:
  - script/shift_source.py  (ego pose shifting)
  - render.py               (trajectory rendering)

Unlike shift_source.py which writes shifted ego_pose files to disk, this script
shifts camera poses in-memory after dataset loading. This ensures object/track
processing uses original poses (matching the trained checkpoint) while rendering
uses the shifted viewpoint.

Example:
    python render_shifted.py \
        --source_path /home/yusen/Downloads/yswang_data3/clip_M18-2_07_20251227122737_DF \
        --model_path /home/yusen/Downloads/yswang_data3/clip_M18-2_07_20251227122737_DF/test_streetgs_clip_M18-2_07_20251227122737_DF_7v_crt \
        --output_dir /home/yusen/Downloads/yswang_data3/clip_M18-2_07_20251227122737_DF/test_output \
        --shift shift_right
"""
