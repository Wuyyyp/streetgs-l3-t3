...
# Optional GSAPro contribution pruning, independent of standard opacity/size pruning.
cfg.optim.static_prune_enabled = False
cfg.optim.static_prune_interval = 5000
cfg.optim.static_prune_until_iter = -1 # Optional inclusive final prune; -1 preserves legacy schedule.
cfg.optim.static_prune_cdf_threshold = 0.99
